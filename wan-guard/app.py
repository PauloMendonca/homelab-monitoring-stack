...
PREFERRED_WHEN_BOTH_BAD = os.getenv("PREFERRED_WHEN_BOTH_BAD", "WAN_VIVO_DHCP")
SECONDARY_WAN_NAME = os.getenv("SECONDARY_WAN_NAME", "WAN_VERO_DHCP")
...
WAN_INTERFACE_MAP_RAW = os.getenv(
    "WAN_INTERFACE_MAP",
    "WAN_VIVO_DHCP:opt1,WAN_VERO_DHCP:wan",
).strip()
